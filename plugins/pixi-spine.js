        ...
        (function(core) {
            var IkConstraint = (function() {
                ...
                IkConstraint.prototype.apply1 = function(bone, targetX, targetY, alpha) {
                    ...
                    var x = targetX - pp.tx,
                        y = targetY - pp.ty;
                    var tx = (x * pp.d - y * pp.c) * id - bone.ax,
                        ty = (y * pp.a - x * pp.b) * id - bone.ay;
        ...
        (function(core) {
            var SkeletonData = (function() {
                ...
                SkeletonData.prototype.findAnimation = function(animationName) {
                    ...
                    /*tyadd find animation weith index Num*/
                    if (!isNaN(animationName)) {
                        if(animationName<animations.length)
                        return animations[animationName];
                        else throw new Error("animationIndexNum not be find");
                    } else {
